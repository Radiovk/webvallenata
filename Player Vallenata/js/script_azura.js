const RADIO_NAME = 'Rádio Studio Bala';

// Change Azuracast Stream URL Here, .
const URL_STREAMING = 'https://stream-54.zeno.fm/87t0h7c51zquv';

//API URL Azuracast Now Playing
const API_URL = 'https://stream-54.zeno.fm/87t0h7c51zquv';
...
class Page {
    constructor() {
        ...
        this.refreshLyric = function (currentSong, currentArtist) {
            ...
            xhttp.open('GET', 'https://api.vagalume.com.br/search.php?apikey=' + API_KEY + '&art=' + currentArtist + '&mus=' + currentSong.toLowerCase(), false);
            xhttp.send();
        };
    }
}
